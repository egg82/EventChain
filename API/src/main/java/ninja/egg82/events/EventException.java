...
public class EventException extends Exception {
    private final transient EventSubscriber<?, ?> subscriber;
    private final Class<?> eventClass;
    private final SubscriberStage stage;

    public <S extends EventSubscriber<S, T>, T> EventException(
            @NotNull EventSubscriber<S, T> subscriber, @NotNull Class<T> eventClass, @NotNull SubscriberStage stage, String message
    ) {
        super(message);
    ...
    public <S extends EventSubscriber<S, T>, T> EventException(
            @NotNull EventSubscriber<S, T> subscriber, @NotNull Class<T> eventClass, @NotNull SubscriberStage stage, Throwable cause
    ) {
        super(cause);
        this.subscriber = subscriber;
        this.eventClass = eventClass;
    ...
    public <S extends EventSubscriber<S, T>, T> EventException(
            @NotNull EventSubscriber<S, T> subscriber, @NotNull Class<T> eventClass, @NotNull SubscriberStage stage, String message, Throwable cause
    ) {
        super(message, cause);
        this.subscriber = subscriber;
        this.eventClass = eventClass;
