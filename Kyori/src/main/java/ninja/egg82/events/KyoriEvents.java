...
public class KyoriEvents {
     ...
     */
    public static <T extends E, E> @NotNull KyoriEventSubscriber<T, E> subscribe(@NotNull EventBus<E> bus, @NotNull Class<T> event) { return new KyoriEventSubscriber<>(bus, event, PostOrders.NORMAL); }
     ...
     * @throws NullPointerException if {@code bus} or {@code event} is null
     */
    public static <T extends E, E> @NotNull KyoriEventSubscriber<T, E> subscribe(@NotNull EventBus<E> bus, @NotNull Class<T> event, int priority) { return new KyoriEventSubscriber<>(bus, event, priority); }
     ...
     */
    public static <T extends E, E> void call(@NotNull EventBus<E> bus, @NotNull T event) { bus.post(event); }
     ...
     */
    public static <E1, T> @NotNull KyoriMergedEventSubsciber<E1, T> merge(@NotNull EventBus<E1> bus, @NotNull Class<T> superclass) { return new KyoriMergedEventSubsciber<>(bus, superclass); }
     ...
     */
    public static <E1 extends T, T> @NotNull KyoriMergedEventSubsciber<E1, T> merge(@NotNull EventBus<E1> bus, @NotNull Class<T> superclass, @NotNull Class<E1>... events) { return merge(bus, superclass, PostOrders.NORMAL, events); }
     ...
     * @throws NullPointerException if {@code bus}, {@code superclass}, or {@code events} are null
     */
    public static <E1 extends T, T> @NotNull KyoriMergedEventSubsciber<E1, T> merge(@NotNull EventBus<E1> bus, @NotNull Class<T> superclass, @NotNull int priority, @NotNull Class<E1>... events) {
