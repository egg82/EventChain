...
public class Pi4JEvents {
    ...
    public static <T> MergedPi4JDigitalEventSubscriber<T> merge(GpioPinDigitalInput input, Class<T> commonClass) { return new MergedPi4JDigitalEventSubscriber<>(input, commonClass); }

    public static <T> MergedPi4JAnalogEventSubscriber<T> merge(GpioPinAnalogInput input, Class<T> commonClass) { return new MergedPi4JAnalogEventSubscriber<>(input, commonClass); }
